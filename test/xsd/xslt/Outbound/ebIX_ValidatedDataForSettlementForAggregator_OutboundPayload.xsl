...
<xsl:stylesheet version="2.0"
	...
	xmlns:crs="un:unece:260:data:EEM-ValidatedDataForSettlementForAggregator"
	xmlns:enrich="java:com.cgi.cms.mhb.utl.mtc.enrich.XMLEnricher"
	exclude-result-prefixes="enrich">
	<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="no" />

	<xsl:template match="entity">
		<crs:ValidatedDataForSettlementForAggregator
		xsi:schemaLocation="un:unece:260:data:EEM-ValidatedDataForSettlementForAggregator ebIX_ValidatedDataForSettlementForAggregator_2014pB.xsd" >
			<crs:Header>
				...
				<crs:DocumentType listAgencyIdentifier="260">E66</crs:DocumentType>
				<crs:Creation>
			...
			<xsl:for-each select=".//*[_type='TRANSACTION']">
				<crs:PayloadEnergyTimeSeries>
					...
					<crs:MPDetailMeasurementMeteringPointCharacteristic>
						<crs:MeteringPointType listAgencyIdentifier="260">E18</crs:MeteringPointType>
					</crs:MPDetailMeasurementMeteringPointCharacteristic>
					<crs:MeteringPointUsedDomainLocation>
						<crs:Identification schemeAgencyIdentifier="9">
					...
					<xsl:for-each select=".//*[_type='OBS']">
						<crs:ObservationIntervalObservationPeriod>
							...
							<crs:ObservationDetailEnergyObservation>
								...
								<xsl:choose>
									<xsl:when test="QQ=0">
										<crs:QuantityMissing>true</crs:QuantityMissing>
									</xsl:when>
								</xsl:choose>	-->							
								<!-- Quantity Quality(QQ):
									NONE(0): 21(temporary)
