...
<xsl:stylesheet version="2.0"
	...
	xmlns:urn17="urn:fi:Datahub:mif:masterdata:F22_MasterDataProductEvent:v1" 
    xmlns:urn18="urn:fi:Datahub:mif:masterdata:F22_MasterDataProductEvent:elements:v1">
					...
					<urn17:MasterDataProductEvent>
						...
						<urn17:Transaction>
							<urn18:ProductOwner schemeAgencyIdentifier="9">
								<xsl:value-of select=".//*[_type='F22_TRP']/OrganisationIdentifier" />
							</urn18:ProductOwner>
							<urn18:ProductIdentification>
								<xsl:value-of select=".//*[_type='F22_TRP']/ProductCode" />
							</urn18:ProductIdentification>
							<urn18:ProductComponentIdentification>
								<xsl:value-of select=".//*[_type='F22_TRP']/ProductComponentCode" />
							</urn18:ProductComponentIdentification>
							<urn18:Price>
								<xsl:value-of select=".//*[_type='F22_PRC']/Price" />
							</urn18:Price>
							<urn18:PriceWithTax>
								<xsl:value-of select=".//*[_type='F22_PRC']/PriceWithTax" />
							</urn18:PriceWithTax>
							<urn18:PriceValidityTime>
								<urn18:Start>
									<xsl:value-of select=".//*[_type='F22_PRC']/StartOfOccurrence" />
								</urn18:Start>
								<xsl:if test=".//*[_type='F22_PRC']/EndOfOccurrence">
								<urn18:End>
									<xsl:value-of select=".//*[_type='F22_PRC']/EndOfOccurrence" />
								</urn18:End>
								</xsl:if>
							</urn18:PriceValidityTime>
						</urn17:Transaction>
