...
<xsl:stylesheet version="2.0"
	...
	<xsl:import href="F02_Payload.xsl" />
	...
	<xsl:template name="MessageTemplate"
		...
		<entity>
			...
			<xsl:if test="//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyIndustryClassification']">
				<Industry>
					<xsl:value-of select="//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyvClassification']" />
				</Industry>
			</xsl:if>
						...
						<_entities_element>
							...
							<xsl:if test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']">
								<InternalTransactionType>
									<xsl:choose>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-131-1'">ACP.LSI</xsl:when>
										<xsl:otherwise>
							...
							<xsl:if test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']">
								<PayloadType>
									<xsl:choose>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-131-1'">ACP.LSI.REQ</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']" />
										</xsl:otherwise>
									</xsl:choose>
