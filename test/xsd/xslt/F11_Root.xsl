...
<xsl:stylesheet version="2.0"
	...
	<xsl:import href="F11_Payload.xsl" />
						...
						<_entities_element>
							...
							<xsl:if test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']">
								<InternalTransactionType>
									<xsl:choose>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-711'">PRD.CRS</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-712'">PRD.CRD</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-717'">PRD.UPS</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-718'">PRD.UPD</xsl:when>
										<xsl:otherwise>
							...
							<xsl:if test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']">
								<PayloadType>
									<xsl:choose>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-711'">PRD.CRS.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-712'">PRD.CRD.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-717'">PRD.UPS.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-718'">PRD.UPD.REQ</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']" />
										</xsl:otherwise>
									</xsl:choose>
						...
						<_entities_element>
							...
							<_entities>
								<_entities_element>
									...
									<_type>F11_TRP</_type>
									<xsl:if test=".//*[local-name()='Transaction']/*[local-name()='ValidityTime']/*[local-name()='Start']">
										<StartOfOccurrence>
											<xsl:value-of select="replace(.//*[local-name()='Transaction']/*[local-name()='ValidityTime']/*[local-name()='Start'], '\+00:00', 'Z')" />
										</StartOfOccurrence>
									</xsl:if>
									<xsl:if test=".//*[local-name()='Transaction']/*[local-name()='ValidityTime']/*[local-name()='End']">
										<EndOfOccurrence>
											<xsl:value-of select="replace(.//*[local-name()='Transaction']/*[local-name()='ValidityTime']/*[local-name()='End'], '\+00:00', 'Z')" />
										</EndOfOccurrence>
									</xsl:if>
