...
<xsl:stylesheet version="2.0"
	...
	<xsl:import href="F03_Payload.xsl" />
						...
						<_entities_element>
							...
							<xsl:if test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']">
								<InternalTransactionType>
									<xsl:choose>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-132-1'">ACP.RTC</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-133-1'">ACP.RTW</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-134-1'">ACP.RTD</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-135-1'">ACP.RTT</xsl:when>
										<xsl:otherwise>
							...
							<xsl:if test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']">
								<PayloadType>
									<xsl:choose>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-132-1'">ACP.RTC.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-133-1'">ACP.RTW.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-134-1'">ACP.RTD.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-135-1'">ACP.RTT.REQ</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']" />
										</xsl:otherwise>
									</xsl:choose>
						...
						<_entities_element>
							...
							<_entities>
								<_entities_element>
									...
									<StartOfOccurrence>
										<xsl:choose>
											<xsl:when test=".//*[local-name()='Transaction']/*[local-name()='StartOfOccurrence']">
