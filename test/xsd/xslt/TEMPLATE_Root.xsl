...
<xsl:stylesheet version="2.0"
	...
	<xsl:import href="#PAYLOADTYPE#_Payload.xsl" />

	<xsl:param name="TenantCode" select="'#TENANTCODE#'" />
						...
						<_entities_element>
							...
							<xsl:if test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']">
								<InternalTransactionType>
									<xsl:choose>
#InternalTransactionType#										<xsl:otherwise>
...
#PayloadType#										<xsl:otherwise>
						...
						<_entities_element>
							...
							<_entities>
								<_entities_element>
									<_name>#PAYLOAD_ENTITY_NAME#</_name>
									<_type>#PAYLOAD_ENTITY_TYPE#</_type>
#StartOfOccurrence#
#EndOfOccurrence#
