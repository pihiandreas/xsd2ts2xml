...
<xsl:stylesheet version="2.0"
	...
	<xsl:import href="F14_Payload.xsl" />
				...
				<_entities_element>
					...
					<_entities>
						<_entities_element>
							...
							<xsl:if test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']">
								<InternalTransactionType>
									<xsl:choose>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-741-1'">IVR.RTS</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-742-1'">IVR.RTD</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-743-1'">IVR.RTT</xsl:when>
										<xsl:otherwise>
							...
							<xsl:if test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']">
								<PayloadType>
									<xsl:choose>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-741-1'">IVR.RTS.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-742-1'">IVR.RTD.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-743-1'">IVR.RTT.REQ</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']" />
										</xsl:otherwise>
									</xsl:choose>
						...
						<_entities_element>
							...
							<_entities>
								<_entities_element>
									<_name>RequestInvoicingDataInfo</_name>
									<_type>RequestInvoicingDataInfo</_type>
