...
<xsl:stylesheet version="2.0"
	...
	<xsl:import href="F13_Payload.xsl" />
	...
	<xsl:template name="MessageTemplate"
		...
		<entity>
			...
			<_entities>
				<_entities_element>
                    ...
                    <InternalTransactionType>
                        <xsl:choose>
                            ...
                            <xsl:when test="//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-733-1'">IVR.CRX</xsl:when>							
                            <xsl:otherwise>
                ...
                <TransactionCount>
					<xsl:value-of select="count(//*[local-name()='Transaction'])"/>
                </TransactionCount>
				</_entities_element>
				<xsl:apply-templates />
			</_entities>
