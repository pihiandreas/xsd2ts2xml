...
<xsl:stylesheet version="2.0"
	...
	<xsl:import href="E58_Payload.xsl" />
						...
						<_entities_element>
							...
							<xsl:if test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']">
								<InternalTransactionType>
									<xsl:choose>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-121'">ACP.CRE</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-122-1' and (.//*[local-name()='Transaction']/*[local-name()='UpdateReason']!='BM02' or not(.//*[local-name()='Transaction']/*[local-name()='UpdateReason']))">ACP.UPD</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-122-1' and .//*[local-name()='Transaction']/*[local-name()='UpdateReason']='BM02'">ACP.UPD.EAC</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-123'">ACP.DEL</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-124-1'">ACP.UPS</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-125-1'">ACP.UPD.MTS</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-126-1'">ACP.CRE.REL</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-127-1'">ACP.END.REL</xsl:when>
										<xsl:otherwise>
							...
							<xsl:if test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']">
								<PayloadType>
									<xsl:choose>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-121'">ACP.CRE.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-122-1' and (.//*[local-name()='Transaction']/*[local-name()='UpdateReason']!='BM02' or not(.//*[local-name()='Transaction']/*[local-name()='UpdateReason']))">ACP.UPD.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-122-1' and .//*[local-name()='Transaction']/*[local-name()='UpdateReason']='BM02'">ACP.UPD.EAC.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-123'">ACP.DEL.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-124-1'">ACP.UPS.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-125-1'">ACP.UPD.MTS.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-126-1'">ACP.CRE.REL.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-127-1'">ACP.END.REL.REQ</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']" />
										</xsl:otherwise>
									</xsl:choose>
						...
						<_entities_element>
							...
							<_entities>
								<_entities_element>
									...
									<xsl:choose>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-122-1' and .//*[local-name()='Transaction']/*[local-name()='UpdateReason']='BM02'">
											<_type>E58_TRP_EAC</_type>
										</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-125-1'">
											<_type>E58_TRP_MTS</_type>
										</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-126-1'">
											<_type>E58_TRP_CRL</_type>
										</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-127-1'">
											<_type>E58_TRP_ERL</_type>
										</xsl:when>										
										<xsl:otherwise>
											<_type>E58_TRP</_type>
										</xsl:otherwise>
									</xsl:choose>
									<xsl:if test=".//*[local-name()='Transaction']/*[local-name()='StartOfOccurrence']">
										<xsl:choose>
											<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']='DH-127-1'">
												<EndOfOccurrence>
													<xsl:value-of select="replace(.//*[local-name()='Transaction']/*[local-name()='StartOfOccurrence'], '\+00:00', 'Z')" />
												</EndOfOccurrence>
											</xsl:when>										
											<xsl:otherwise>
												<StartOfOccurrence>
									...
									<xsl:if test=".//*[local-name()='Transaction']/*[local-name()='EndOfOccurrence']">
										<EndOfOccurrence>
											<xsl:value-of select="replace(.//*[local-name()='Transaction']/*[local-name()='EndOfOccurrence'], '\+00:00', 'Z')" />
										</EndOfOccurrence>
									</xsl:if>
									...
									<xsl:if test=".//*[local-name()='Transaction']/*[local-name()='UpdateReason']">
										<UpdateReason>
											<xsl:value-of select=".//*[local-name()='Transaction']/*[local-name()='UpdateReason']" />
										</UpdateReason>
									</xsl:if>
