...
<xsl:stylesheet version="2.0"
	...
	<xsl:import href="F23_Payload.xsl" />
				...
				<_entities_element>
					...
					<xsl:if	test="//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']">
						<ExternalTransactionType>
							<xsl:choose>
								<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcessRole']='DDQ'">DH-715</xsl:when>
								<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcessRole']='DDM'">DH-716</xsl:when>
							</xsl:choose>
						</ExternalTransactionType>
					</xsl:if>
					<_entities>
						<_entities_element>
							...
							<xsl:if test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']">
								<InternalTransactionType>
									<xsl:choose>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcessRole']='DDQ'">TSV.UPS</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcessRole']='DDM'">TSV.UPD</xsl:when>										<xsl:otherwise>
							...
							<xsl:if test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']">
								<PayloadType>
									<xsl:choose>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcessRole']='DDQ'">TSV.UPS.REQ</xsl:when>
										<xsl:when test=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcessRole']='DDM'">TSV.UPD.REQ</xsl:when>										<xsl:otherwise>
											<xsl:value-of select=".//*[local-name()='ProcessEnergyContext']/*[local-name()='EnergyBusinessProcess']" />
										</xsl:otherwise>
									</xsl:choose>
								</PayloadType>
						...
						<_entities_element>
							...
							<_entities>
								<_entities_element>
									...
									<_type>F23_TRP</_type>
									<xsl:if test=".//*[local-name()='Transaction']/*[local-name()='Start']">
										<StartOfOccurrence>
											<xsl:value-of select="replace(.//*[local-name()='Transaction']/*[local-name()='Start'], '\+00:00', 'Z')" />
										</StartOfOccurrence>
									</xsl:if>
									<xsl:if test=".//*[local-name()='Transaction']/*[local-name()='End']">
										<EndOfOccurrence>
											<xsl:value-of select="replace(.//*[local-name()='Transaction']/*[local-name()='End'], '\+00:00', 'Z')" />
										</EndOfOccurrence>
									</xsl:if>
